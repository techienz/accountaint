  ...
  switch (toolName) {
    ...
    case "get_upcoming_deadlines": {
      ...
      const deadlines = calculateDeadlines({
        ...
        gst_2monthly_cycle: config.gst_2monthly_cycle as "A" | "B" | undefined,
        tax_agent_linked: config.tax_agent_linked,
        pays_dividends: config.pays_dividends,
        has_shareholder_employee: config.has_shareholder_employee,
        companies_office_annual_return_month: config.companies_office_annual_return_month,
    ...
    case "get_business_config": {
      ...
      return {
        ...
        gst_2monthly_cycle: config.gst_2monthly_cycle,
        tax_agent_linked: config.tax_agent_linked,
        pays_dividends: config.pays_dividends,
        has_shareholder_employee: config.has_shareholder_employee,
        companies_office_annual_return_month: config.companies_office_annual_return_month,
