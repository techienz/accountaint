...
export const typeColors: Record<string, string> = {
  ...
  ir6: "bg-fuchsia-100 text-fuchsia-800 dark:bg-fuchsia-900/30 dark:text-fuchsia-400",
  ir7: "bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-400",
  imputation_return: "bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400",
  rwt_dividend_payment: "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400",
  rwt_annual_reconciliation: "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400",
...
export const typeLabels: Record<string, string> = {
  ...
  ir6: "IR6",
  ir7: "IR7",
  imputation_return: "IR4J Imputation",
  rwt_dividend_payment: "RWT (IR15P)",
  rwt_annual_reconciliation: "RWT Annual (IR15S)",
